...
const Logo = () => (
  <div className="flex items-center gap-2">
    <div className="w-8 h-8 bg-[#1a1a1a] rounded-[9px] flex items-center justify-center">
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* Icon ring */}
            <div className="w-18 h-18 rounded-full bg-[#fff5f3] border-[6px] border-[#fde8e4] flex items-center justify-center mx-auto mb-5">
            ...
            <div className="flex gap-2.5">
              <button
                onClick={onClose}
                className="flex-1 py-3 border border-[#ede8e3] rounded-xl text-[13px] font-medium text-gray-500 bg-white hover:bg-[#f7f4f1] transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button
                onClick={onClose}
                className="flex-1 py-3 rounded-xl text-[13px] font-semibold text-white hover:opacity-90 transition-opacity cursor-pointer"
...
export default function CardVerificationForm() {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full max-w-105 bg-white rounded-3xl border border-[#f0e8e0] p-8"
        style={{ boxShadow: "0 4px 32px rgba(232,80,58,0.07)" }}
      >
        {/* Brand */}
        <div className="mb-6">
          <Logo />
        ...
        <div
          ...
          style={{ maxHeight: showExtra ? 320 : 0, opacity: showExtra ? 1 : 0 }}
        >
